...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:ScriptManager ID="sm_portal" runat="server">
            </asp:ScriptManager>
            <hr />
            <br />
            <h3 class="text-center">&nbsp;<asp:Label ID="lb_topMessage" runat="server"></asp:Label>
            </h3>
            <p class="text-center">
                <asp:Button ID="btn_refresh" runat="server" Height="50px" Text="Refresh Tables" CssClass="btn btn-outline-dark" OnClick="btn_refresh_Click" Width="150px" />
            </p>
            <hr />
            <br />
            <asp:UpdatePanel ID="up_portal" runat="server">
                <ContentTemplate>
            <h2 class="text-center">&nbsp;<span class="text-decoration-underline">Current Orders</span></h2>               
            ...
            <br />
            <br />
            <h2 class="text-center">&nbsp;<span class="text-decoration-underline">Customers</span></h2>            
            ...
            <center><p>Order / Customer Number -
                ...
                <br />
                <p>
                    <asp:Button ID="btn_deleteOrder" runat="server" Text="Delete" Height="50px" Width="150px" CssClass="btn btn-danger" OnClick="btn_deleteOrder_Click" />
                </p>
            </center>             
        </div>
    </form>
